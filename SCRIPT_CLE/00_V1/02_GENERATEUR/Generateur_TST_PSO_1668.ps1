...
# Version 		: 	1.0
# Description 	: 	Generateur de la famille de test NExTEO_ATS_SFE_TST_PSO-1668 Clé 21
#
...
### CLE 41				
				...
				[String] $exp = "((keyTest1 == 0) && Verif$TsTkAuAtr && Verif$TsCoAtr)"
...
### CLE 21
				...
				# Ecriture du resultat et de la fin du step
				[String] $exp = "((keyTest == 0) && (confirmSetUpTest == 0) && Verif$TsTkAuAtr && Verif$TsCoAtr)"
				WriteStepEnd -exp $exp -numStep $numStep -comment "Test realise automatiquement" -numTest $numTest -OutputScript $OutputScript -LogFullPath $LogFullPath
